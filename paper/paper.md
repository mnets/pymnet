...
**TODO Description of Basic Functionality and Data Types**

[pymnet](https://github.com/mnets/pymnet) also contains submodules for advanced structural analysis of multilayer networks. 
...
and [pymnet](https://github.com/mnets/pymnet) implements graphlet-degree analysis for single-aspect multiplex networks. 
...
[pymnet](https://github.com/mnets/pymnet) extends the popular [networkx](https://networkx.org/) package developed for single-layer graph analysis such that (some) [networkx](https://networkx.org/) functions can be applied to the individual layers of a multilayer network. 
